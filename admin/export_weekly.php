...
try {
    ...
    // Log the error and show a warning instead of breaking the site
    error_log("Export weekly failed: " . $e->getMessage());
    echo "<script>alert('Export failed: Please contact the team for assistance.');</script>";
